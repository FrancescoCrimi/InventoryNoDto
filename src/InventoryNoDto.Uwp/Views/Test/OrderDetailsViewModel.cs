...
namespace Inventory.Uwp.Views.Test
{
    public class OrderDetailsViewModel : ViewModelBase
    {
        ...
        public ICommand CustomerSelectedCommand => _customerSelectedCommand
            ?? (_customerSelectedCommand = new RelayCommand<Customer>(OnCustomerSelected));
        ...
        private async Task<Order> GetItemAsync(long id)
        {
